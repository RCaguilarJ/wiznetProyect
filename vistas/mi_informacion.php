...
// 2. Lógica para Pestaña SERVICIO (Plan contratado)
...
// 3. Lógica Seguridad (CAMBIO DE CONTRASEÑA REAL)
    ...
    if ($pass_nueva === $pass_conf) {
        ...
        if($conn->query($sql_upd)){
            ...
            $tipo_mensaje = "success";
             ...
             $mensaje = "Error al actualizar en BD: " . $conn->error;
             $tipo_mensaje = "error";
        }
    } else {
...
<style>
    ...
    @media(max-width: 600px) { .info-grid { grid-template-columns: 1fr; } .full-width { grid-column: span 1; } }
</style>
